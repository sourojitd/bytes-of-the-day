...
### Tool of the Week
**ripgrep (recap 2018)** — Fast recursive search by Rust (`rg`).
...
### Tool of the Week
**fzf (recap 2023)** — Command-line fuzzy finder.
...
### Tool of the Week
**htop (recap 2023)** — Interactive process viewer.
...
### Tool of the Week
**ripgrep (recap 2024)** — Fast recursive search by Rust (`rg`).
...
### Tool of the Week
**jq (recap 2024)** — Lightweight JSON processor for the CLI.
...
### Tool of the Week
**ripgrep (recap 2025)** — Fast recursive search by Rust (`rg`).
...
### Tool of the Week
**jq (recap 2025)** — Lightweight JSON processor for the CLI.
